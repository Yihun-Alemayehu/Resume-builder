...
class HybridTemplateState extends State<HybridTemplate> {
  ...
  List<File> icons = [
    ...
    File('assets/Icons/skill1.png'),
    File('assets/Icons/certificate.png'),
    File('assets/Icons/award.png'),
    File('assets/Icons/language1.png'),
                                                            ...
                                                            children: [
                                                              ...
                                                              SizedBox(
                                                                ...
                                                                child:
                                                                  ...
                                                                  controller: achievementsControllers[
                                                                          index]
                                                                      [
                                                                      innerIndex],
                                                                  style:
