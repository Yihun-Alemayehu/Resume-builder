...
class DesertTemplate extends StatefulWidget {
  ...
  @override
  State<DesertTemplate> createState() => DesertTemplateState();
}

class DesertTemplateState extends State<DesertTemplate> {
                                                                ...
                                                                templateData =
                                                                  ...
                                                                  workExperience: templateData
                                                                      ...
                                                                      .map((e) =>
                                                                          e.copyWith(
                                                                            achievements:
                                                                                e.achievements.asMap().map((i, c) => MapEntry(i, i == innerIndex ? value : c)).values.toList().toList(),
                                                                          ))
                                                                      .toList(),
                                                                );
                                                              });
